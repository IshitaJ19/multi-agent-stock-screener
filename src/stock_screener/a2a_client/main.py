...
from stock_screener.a2a_client.host_agent import (
    root_agent
)
...
async def get_response_from_agent(
    ...
    try:
        ...
        # This block will be executed when the generator is closed,
        # either by finishing, breaking, or being cancelled.
        print("get_response_from_agent generator is closing.")
...
async def main():
    ...
    with gr.Blocks(
        ...
        gr.ChatInterface(
            ...
            title='Stock Screener Host Agent',
            description='This assistant can help you find and screen stocks for investment purposes.',
        )
